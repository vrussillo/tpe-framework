...
import SearchLocationInput from "../../utils/Google/SearchLocationInput.js";
import { transportationPricing } from "../../utils/TransportationPricing";
...
const Transportation = () => {
  ...
  return (
    <Main className="sub-entry-transportation-one">
...
const TableInput = (props) => {
  ...
  return (
    <input
      ...
      id="form-control-transportation"
      type="number"
      value={cell.value}
      onChange={onChange}
    />
...
const ReactTable = memo((props) => {
  ...
  const [data, setData] = useState(transportationPricing);
  const resetData = () => setData(transportationPricing);
